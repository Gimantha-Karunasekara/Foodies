...
//
    ...
    public static void initFood(FoodDBModel foodAppDBModel)
    {
        ...
        FoodItem foodItem3 = new FoodItem(3, "Burger - type 3"
                , "This is a veryyyy long description as you can see right here rewrewwrewfsdfsafewfawffwefwfwfwffsdkjerkwjrkwrnnjwenrjwenrnjjenrjnwernwjkr",R.drawable.res_bk, 234.56f, 1);
